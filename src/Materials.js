// Środek poprzedniego App.js
// Skorzystajmy z tego i później będzie do usunięcia
// Ten plik nie jest nigdzie importowany ani eksportowany
      ...
      <ul>
        {apiData.posts.map((post) => (
          <li key={post.postID}>
            ...
            {apiData.users.find((user) => user.userID === post.userID).nazwa})
            <p>{post.tresc}</p>
            <p>
